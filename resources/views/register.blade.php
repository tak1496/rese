...
<main>
  <section>
    <div class="form_layout">
      <form method="post" action="{{ route('register') }}?path={{ $path }}&shop_id={{ $shop_id }}&shop_password={{ $shop_password }}&menu={{ $menu }}&reserve={{ $reserve }}&date={{ $date }}&time={{ $time }}&member={{ $member }}">
